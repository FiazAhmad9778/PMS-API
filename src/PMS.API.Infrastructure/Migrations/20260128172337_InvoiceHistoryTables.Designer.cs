...
namespace PMS.API.Infrastructure.Migrations
{
    ...
    [Migration("20260128172337_InvoiceHistoryTables")]
    partial class InvoiceHistoryTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.Identity.ApplicationClaim", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("AllowedSubscriptions")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("FaxErrorMessage")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)")
                        .HasColumnName("faxErrorMessage");

                    b.Property<int>("FaxRetryCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("faxRetryCount");

                    b.Property<DateTime?>("FaxSentAt")
                        .HasColumnType("datetime2")
                    ...
                    b.Property<string>("FaxTransactionId")
                        .HasMaxLength(200)
                    ...
                    b.HasIndex("WebhookId")
                        .IsUnique()
                        .HasFilter("[webhookId] IS NOT NULL");
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.PatientInvoiceHistory", b =>
                {
                    b.Property<long>("PatientInvoiceHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("PatientInvoiceHistoryId"));
                    ...
                    b.Property<string>("InvoiceSendingWays")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("PatientInvoiceHistoryId");

                    b.ToTable("PatientInvoiceHistory");
                });

            modelBuilder.Entity("PMS.API.Core.Domain.Entities.PatientInvoiceHistoryWard", b =>
                {
                    b.Property<long>("PatientInvoiceHistoryWardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("PatientInvoiceHistoryWardId"));
                    ...
                    b.HasKey("PatientInvoiceHistoryWardId");

                    b.HasIndex("PatientInvoiceHistoryId");

                    b.ToTable("PatientInvoiceHistoryWard");
                });
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.PatientInvoiceHistoryWard", b =>
                {
                    b.HasOne("PMS.API.Core.Domain.Entities.PatientInvoiceHistory", "PatientInvoiceHistory")
                        .WithMany("PatientInvoiceHistoryWardList")
                        .HasForeignKey("PatientInvoiceHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PatientInvoiceHistory");
                });
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.PatientInvoiceHistory", b =>
                {
                    b.Navigation("PatientInvoiceHistoryWardList");
                });
