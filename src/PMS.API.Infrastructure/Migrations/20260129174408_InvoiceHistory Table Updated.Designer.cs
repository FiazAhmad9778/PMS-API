...
namespace PMS.API.Infrastructure.Migrations
{
    ...
    [Migration("20260129174408_InvoiceHistory Table Updated")]
    partial class InvoiceHistoryTableUpdated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.PatientInvoiceHistory", b =>
                {
                    ...
                    b.ToTable("PatientInvoiceHistory", (string)null);
                });
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.PatientInvoiceHistoryWard", b =>
                {
                    ...
                    b.ToTable("PatientInvoiceHistoryWard", (string)null);
                });
