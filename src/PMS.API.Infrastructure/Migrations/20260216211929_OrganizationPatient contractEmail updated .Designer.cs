...
namespace PMS.API.Infrastructure.Migrations
{
    ...
    [Migration("20260216211929_OrganizationPatient contractEmail updated ")]
    partial class OrganizationPatientcontractEmailupdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.InvoiceHistory", b =>
                {
                    ...
                    b.Property<long?>("OrganizationPatientId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("OrganizationPatientId");
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Property<bool>("IsPatientRequired")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.OrganizationPatient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("OrganizationPatient", (string)null);
                });
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.InvoiceHistory", b =>
                {
                    b.HasOne("PMS.API.Core.Domain.Entities.Organization", "Organization")
                        .WithMany("InvoiceHistoryList")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PMS.API.Core.Domain.Entities.OrganizationPatient", "OrganizationPatient")
                        .WithMany("InvoiceHistoryList")
                        .HasForeignKey("OrganizationPatientId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PMS.API.Core.Domain.Entities.Patient", "Patient")
                        .WithMany("InvoiceHistoryList")
                    ...
                    b.Navigation("OrganizationPatient");
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.OrganizationPatient", b =>
                {
                    b.HasOne("PMS.API.Core.Domain.Entities.Organization", "Organization")
                        .WithMany("OrganizationPatientList")
                        .HasForeignKey("OrganizationId")
            ...
            modelBuilder.Entity("PMS.API.Core.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Navigation("OrganizationPatientList");
