...
cd /var/www/PMS-API/src && dotnet ef database update --project PMS.API.Infrastructurclse/PMS.API.Infrastructure.csproj --startup-project PMS.API.Web/PMS.API.Web.csproj