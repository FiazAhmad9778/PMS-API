...
public class GetWardDropdownQueryHandler : RequestHandlerBase<GetWardDropdownQuery, ApplicationResult<List<WardResponseDto>>>
{
  ...
  public GetWardDropdownQueryHandler(
    ...
    ILogger<GetWardDropdownQueryHandler> logger) : base(serviceProvider, logger)
  {
  ...
  protected override async Task<ApplicationResult<List<WardResponseDto>>> HandleRequest(GetWardDropdownQuery request, CancellationToken cancellationToken)
  {
    try
    {
