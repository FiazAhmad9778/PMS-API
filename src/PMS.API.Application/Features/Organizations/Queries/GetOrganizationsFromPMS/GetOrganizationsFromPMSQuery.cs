...
public class GetOrganizationsFromPMSQuery : PagedQueryBaseRequest, IRequest<ApplicationResult<List<OrganizationResponseDto>>>
{
}

public class GetOrganizationsQueryFromPMSHandler : RequestHandlerBase<GetOrganizationsFromPMSQuery, ApplicationResult<List<OrganizationResponseDto>>>
{
  private readonly IConfiguration _configuration;
  private readonly string _connectionString;
  private readonly string _databaseName;

  public GetOrganizationsQueryFromPMSHandler(
    IConfiguration configuration,
    IServiceProvider serviceProvider,
    ILogger<GetOrganizationsQueryFromPMSHandler> logger) : base(serviceProvider, logger)
  {
  ...
  protected override async Task<ApplicationResult<List<OrganizationResponseDto>>> HandleRequest(GetOrganizationsFromPMSQuery request, CancellationToken cancellationToken)
  {
    try
    {
